...
+
** Des instructions d'installation et de configuration sont disponibles https://["ici"^].


* Kit NetApp DataOps pour Kubernetes
+
** Des instructions d'installation sont disponibles https://["ici"^].
...
....
. Stockez votre modèle sur le nouveau volume persistant dans un https://["format"^] C'est reconnu par le serveur NVIDIA Triton Inférence Server.
+
