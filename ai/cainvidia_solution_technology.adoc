...
|===
link:cainvidia_build_a_virtual_assistant_using_jarvis,_cloud_sync,_and_nemo_overview.html["Ensuite, créez un assistant virtuel à l'aide de Jarvis, de BlueXP Copy and Sync et de Nemo Overview"]
