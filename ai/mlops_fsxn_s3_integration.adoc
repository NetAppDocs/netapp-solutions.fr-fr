...
Cliquez sur le bouton orange *Créer une instance de bloc-notes* en bas à gauche.
+
...
.. Laissez les autres entrées par défaut et cliquez sur le bouton orange *Suivant* en bas à gauche.
+
image:mlops_fsxn_s3_integration_10.png["Erreur : confirmez la configuration"]

.. Cliquez sur le bouton orange *Créer un système de fichiers* en bas à gauche de la page de revue.
+
