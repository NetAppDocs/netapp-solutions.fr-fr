...
link:osrunai_achieving_high_cluster_utilization_with_over-uota_gpu_allocation.html["Suivant : une utilisation élevée des clusters avec une allocation GPU sur-quota"]
