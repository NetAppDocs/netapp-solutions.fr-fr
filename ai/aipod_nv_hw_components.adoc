...
_NVIDIA DGX BasePOD solution_ image::aipod_nv_basepod_layods.png[]
...
_NVIDIA DGX H100 panneau arrière_ image::aipod_nv_H100_REAR.png[]
...
_NVIDIA Spectrum-3 SN4600 Switch_ image::aipod_nv_SN4600_HiRes_LLEGER.png[]
