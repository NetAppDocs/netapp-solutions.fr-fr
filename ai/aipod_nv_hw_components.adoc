...
image::aipod_nv_basepod_layers.png[couches de base de module de base v.aipod]
...
image::aipod_nv_H100_rear.png[Aipod nv H100 arrière]
...
image::aipod_nv_SN4600_hires_smallest.png[L'aipod nv SN4600 est le plus petit]
