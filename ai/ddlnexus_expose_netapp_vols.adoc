...
link:ddlnexus_initial_setup.html["Précédent : configuration initiale."]
...
link:ddlnexus_access_data_hybrid.html["Ensuite, accédez aux mêmes données dans différents environnements."]
