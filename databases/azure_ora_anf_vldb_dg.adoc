...
=== Base de données de secours clone pour d'autres utilisations via l'automatisation

[%collapsible%open]
====
Contactez l'équipe d'ingénierie des solutions NetApp pour obtenir le kit d'automatisation permettant de créer et d'actualiser les clones afin de gérer intégralement le cycle de vie des clones.
