...
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=c0df32f8-d6d3-4b79-b0bd-b01200f3a2e8["Migration d'Oracle Database depuis les systèmes sur site vers FSX/EC2 via SnapMirror et BlueXP"^]
