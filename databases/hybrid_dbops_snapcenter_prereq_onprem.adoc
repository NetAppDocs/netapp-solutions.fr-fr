...
link:hybrid_dbops_snapcenter_prerequisite.html["Précédent : configuration des prérequis."]
...
link:https://https://docs.netapp.com/us-en/snapcenter/install/concept_snapcenter_standard_capacity_based_licenses.html["Licences standard basées sur la capacité SnapCenter"^]
...
Suivez ces instructions pour configurer votre nœud de contrôle Ansible pour les machines RedHat ou CentOS : link:https://review.docs.netapp.com/us-en/netapp-solutions_acao_snapctr/automation/automation_rhel_centos_setup.html["Configuration du contrôleur Red Hat/CentOS Ansible"^]. Suivez ces instructions pour configurer votre nœud de contrôle Ansible pour les machines Ubuntu ou Debian : link:https://review.docs.netapp.com/us-en/netapp-solutions_acao_snapctr/automation/automation_ubuntu_debian_setup.html["Configuration du contrôleur Ansible Ubuntu/Debian"^].

link:hybrid_dbops_snapcenter_prereq_cloud.html["Suivant : cloud public."]
