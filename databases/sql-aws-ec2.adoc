...
|===
Pour plus d'informations, reportez-vous link:https://docs.netapp.com/us-en/snapcenter/protect-scsql/task_install_snapcenter_plug_in_for_microsoft_sql_server_database.html["besoins en termes d'espace et de dimensionnement"]à la .
