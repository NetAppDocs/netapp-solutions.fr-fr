...
| Et des meilleures pratiques 
 ...
 a| 
* Pour des performances de stockage optimales, provisionnez la capacité des systèmes de fichiers jusqu'à 1,5 fois supérieure à la taille totale de l'utilisation de la base de données.
...
|===
Pour plus d'informations, voir exigences en matière d'espace et de dimensionnement (https://docs.netapp.com/us-en/snapcenter/install/reference_space_and_sizing_requirements.html)[]
