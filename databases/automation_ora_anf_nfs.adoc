...
[%collapsible]
====
NetApp recommande l'outil de l'interface utilisateur SnapCenter pour gérer la base de données Oracle déployée dans le cloud Azure. Une documentation détaillée sur la solution sera disponible prochainement.
