...
image::snapctr_svcs_azure_architect.png[Cette image fournit une image détaillée de Cloud Backup pour l'application dans la console BlueXP, notamment l'interface utilisateur, le connecteur et les ressources qu'il gère.]
...
. Pour plus d'informations sur le déploiement de bases de données Oracle sur Azure NetApp Files et l'instance de calcul Azure, reportez-vous à la section link:azure_ora_nfile_usercase.html["Déploiement et protection de bases de données Oracle sur Azure NetApp Files"^].
...
+
image:snapctr_svcs_restore_01-azure.png["Erreur : image graphique manquante"]

. Sélectionnez le *point de restauration* et cochez la *Restaurer à un autre emplacement*.
+
image:snapctr_svcs_clone_01-azure.png["Erreur : image graphique manquante"]
...
+
image:snapctr_svcs_clone_02-azure.png["Erreur : image graphique manquante"]
...
+
image:snapctr_svcs_clone_03-azure.png["Erreur : image graphique manquante"]
...
+
image:snapctr_svcs_clone_04-azure.png["Erreur : image graphique manquante"]
...
+
image:snapctr_svcs_clone_05-azure.png["Erreur : image graphique manquante"]
...
+
image:snapctr_svcs_clone_06-azure.png["Erreur : image graphique manquante"]
...
+
image:snapctr_svcs_clone_07-azure.png["Erreur : image graphique manquante"]
