...
+
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=e479b91f-eacd-46bf-bfa1-b01200f0015a["Déploiement et protection automatisés de bases de données PostreSQL dans AWS EC2/FSX"]
