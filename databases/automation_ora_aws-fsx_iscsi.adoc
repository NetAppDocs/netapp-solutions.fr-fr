...
+
image::automation_ora_aws-fsx_iscsi_em_01.png[Cette image fournit un écran de connexion pour Oracle Enterprise Manager Express]

+
image::automation_ora_aws-fsx_iscsi_em_02.png[Cette image fournit une vue de la base de données de conteneurs à partir d'Oracle Enterprise Manager Express]

+
image::automation_ora_aws-fsx_iscsi_em_03.png[Cette image fournit une vue de la base de données de conteneurs à partir d'Oracle Enterprise Manager Express]
