...
image::snapctr_svcs_clone_02.png[clone des services snapctr 02]

. Sélectionnez l'option *Basic* si vous n'avez pas besoin de modifier les paramètres de base de données clonés.


image::snapctr_svcs_clone_03.png[clone des services snapctr 03]
...
image::snapctr_svcs_clone_03_1.png[clone des services snapctr 03 1]

. Vérifiez et lancez le travail.


image::snapctr_svcs_clone_04.png[clone des services snapctr 04]

. Surveillez l'état du travail de clonage à partir de l'onglet *Job Monitoring*.


image::snapctr_svcs_clone_07-status.png[état du clone 07 des services snapctr]
