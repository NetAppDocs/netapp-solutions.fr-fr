...
. Clonez une copie du kit d'outils d'automatisation du déploiement NetApp pour Oracle pour NFS. Suivez les instructions de la section link:https://docs.netapp.com/us-en/netapp-solutions/databases/automation_ora_anf_nfs.html["TR-4887"^] pour exécuter les playbooks.
+
[source, cli]
----
