...
---
= Déploiement de Microsoft Hyper-V sur un système de stockage NetApp : script de migration
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cette section contient un script PowerShell qui peut être utilisé pour la migration à l'aide de FlexClone.
