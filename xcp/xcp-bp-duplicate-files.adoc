...
link:xcp-bp-using-the-xcp-data-mover-to-migrate-large-files.html["Précédent : utilisation du Data Mover XCP pour migrer des fichiers volumineux."]
...
....
link:xcp-bp-specific-date-based-scan-and-copy-of-data.html["Suivant : analyse et copie de données spécifiques à la date."]
