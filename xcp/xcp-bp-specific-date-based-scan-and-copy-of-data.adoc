...
link:xcp-bp-duplicate-files.html["Précédent : fichiers en double."]
...
c:\XCP>
....
link:xcp-bp-creating-a-csv-file-from-smb-cifs-share.html["Suivant : création d'un fichier CSV à partir d'un partage SMB/CIFS."]
