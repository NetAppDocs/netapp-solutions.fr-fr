...
NOTE: Pour plus d'informations sur l'architecture de haut niveau de l'analytique des fichiers XCP, des vues de tableau de bord basées sur l'interface graphique, telles que les statistiques et les détails de la vue de distribution de fichiers, consultez le bulletin de blog https://["NetApp XCP 1.6 offre des fonctionnalités d'analytique des fichiers ouverts et d'amélioration de l'infrastructure"^].
