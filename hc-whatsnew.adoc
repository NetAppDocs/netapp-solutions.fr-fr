...
| link:containers/devops_with_netapp/dwn_solution_overview.html["Le DevOps avec NetApp Astra"] | link:containers/rh-os-n_videos_astra_control_flexclone.html["Vidéo : accélérez le développement logiciel avec Astra Control et la technologie NetApp FlexClone"] 
