...
Pour en savoir plus sur ce processus, n'hésitez pas à le faire link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=255640f5-4dff-438c-8d50-b01200f017d1["suivez la vidéo de présentation détaillée"].

Voici une capture d'écran de l'option HCX vMotion.

image:anfd-hcx-image20.png["Erreur : image graphique manquante"]

Pour en savoir plus sur ce processus, n'hésitez pas à le faire link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=986bb505-6f3d-4a5a-b016-b01200f03f18["suivez la vidéo de présentation détaillée"].
