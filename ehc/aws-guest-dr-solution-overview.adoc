...
image:dr-vmc-aws-image1.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
link:aws-guest-dr-solution-prereqs.html["Exigences, prérequis et planification de la solution DR"]
...
NOTE: Pour plus d'informations sur la création de relations SnapMirror avec FSX, reportez-vous au https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/ONTAPGuide.pdf["FSX ONTAP – Guide de l'utilisateur ONTAP"^].
...
....
+
image:dr-vmc-aws-image11.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
....
+
image:dr-vmc-aws-image14.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
Le logiciel SnapCenter est disponible sur le site du support NetApp et peut être installé sur les systèmes Microsoft Windows résidant dans un domaine ou un groupe de travail. Un guide de planification détaillé et des instructions d'installation sont disponibles sur le site  https://docs.netapp.com/us-en/snapcenter/install/requirements-to-install-snapcenter-server.html["Centre de documentation NetApp"^] .
...
+
image:dr-vmc-aws-image18.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image19.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image20.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image21.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image22.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
image:dr-vmc-aws-image23.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
* Le paramètre mettre à jour SnapVault après la création d'une copie Snapshot locale permet de mettre à jour une relation SnapMirror qui existe entre deux clusters distincts et entre un système ONTAP sur site et Cloud Volumes ONTAP ou FSX ONTAP.


L'image suivante montre les options ci-dessus et leur apparence dans l'assistant de stratégie de sauvegarde.

image:dr-vmc-aws-image24.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
image:dr-vmc-aws-image25.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image26.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image27.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Ajoutez vos identifiants pour accéder au cluster ONTAP.
+
image:dr-vmc-aws-image28.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Sur la page NAS Filer, choisissez les protocoles à analyser et sélectionnez Suivant.
+
image:dr-vmc-aws-image29.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image30.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image31.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image32.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image33.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image34.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image35.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image37.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image38.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image39.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
SnapCenter permet la sauvegarde et la récupération de sa base de données MySQL sous-jacente et des données de configuration afin de restaurer le serveur SnapCenter en cas d'incident. Pour notre solution, nous avons restauré la base de données et la configuration d'SnapCenter sur une instance EC2 AWS résidant sur notre VPC. Pour plus d'informations sur la reprise après incident de SnapCenter, reportez-vous àla section https://docs.netapp.com/us-en/snapcenter/index.html["ce lien"^].
...
[%collapsible%open]
====
SnapCenter fournit une interface client Web pour l'exécution des commandes de l'API REST. Pour plus d'informations sur l'accès aux API REST via swagger, reportez-vous à la documentation SnapCenter à l'adresse https://docs.netapp.com/us-en/snapcenter/sc-automation/overview_rest_apis.html["ce lien"^].
...
+
image:dr-vmc-aws-image40.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Développez la section Auth et cliquez sur le bouton essayer.
+
image:dr-vmc-aws-image41.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image42.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image43.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image44.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Développez le `/4.6/disasterrecovery/server/backup` Et cliquez sur essayer.
+
image:dr-vmc-aws-image45.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image46.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
image:dr-vmc-aws-image47.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image48.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image49.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image50.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

+
image:dr-vmc-aws-image51.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image52.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image53.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Sélectionnez Amazon S3 comme type de stockage objet.
+
image:dr-vmc-aws-image54.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Dans la liste d'Amazon Cloud Storage Services, sélectionnez Amazon S3.
+
image:dr-vmc-aws-image55.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image56.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image57.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image58.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image59.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Une fois l'importation terminée, vous pouvez restaurer les machines virtuelles dans le cluster VMware Cloud.
+
image:dr-vmc-aws-image60.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image61.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image62.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Sur la page mode de restauration, sélectionnez Restaurer à un nouvel emplacement ou avec des paramètres différents.
+
image:dr-vmc-aws-image63.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Sur la page hôte, sélectionnez l'hôte ou le cluster ESXi cible pour restaurer la machine virtuelle.
+
image:dr-vmc-aws-image64.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Sur la page datastores, sélectionnez l'emplacement du datastore cible pour les fichiers de configuration et le disque dur.
+
image:dr-vmc-aws-image65.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Sur la page réseau, mappez les réseaux d'origine sur la machine virtuelle aux réseaux du nouvel emplacement cible.
+
image:dr-vmc-aws-image66.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

+
image:dr-vmc-aws-image67.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image68.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Dans l'onglet découverte, cliquez sur Discover Portal et entrez les adresses IP de vos cibles iSCSI FSX.
+
image:dr-vmc-aws-image69.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

+
image:dr-vmc-aws-image70.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image71.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image72.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image73.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image74.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image75.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
image:dr-vmc-aws-image76.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
[%collapsible%open]
====
Pour rendre les volumes de stockage secondaires hébergés sur l'instance FSX ONTAP accessibles aux serveurs Oracle, vous devez d'abord interrompre la relation SnapMirror existante.
...
....
+
image:dr-vmc-aws-image77.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
....
+
image:dr-vmc-aws-image78.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Mettez à jour le chemin de jonction dans le client Web Amazon FSX :
+
image:dr-vmc-aws-image79.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image80.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image81.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:dr-vmc-aws-image82.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

+
image:dr-vmc-aws-image83.png["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
Une fois le processus de basculement présenté dans cette solution terminé, SnapCenter et Veeam reprennent leurs fonctions de sauvegarde s'exécutant dans AWS. FSX ONTAP est désormais désigné comme stockage primaire sans relation SnapMirror avec le data Center sur site d'origine. Une fois le fonctionnement normal rétabli sur site, vous pouvez utiliser un processus identique à celui décrit dans la présente documentation pour reproduire les données sur le système de stockage ONTAP sur site.
