...
image::aws-fsx-guest-1.png[client aws fsx 1]
...
image::aws-fsx-guest-2.png[client aws fsx 2]
...
image::aws-fsx-guest-3.png[client aws fsx 3]

. Dans la section mise en réseau, pour le cloud privé virtuel (VPC), choisissez le VPC (Virtual Private Cloud) approprié et les sous-réseaux préférés, ainsi que la table de routage. Dans ce cas, vmcfsx2.vpc est sélectionné dans la liste déroulante.


image::aws-fsx-guest-4.png[client aws fsx 4]
...
image::aws-fsx-guest-5.png[client aws fsx 5]
...
image::aws-fsx-guest-6.png[client aws fsx 6]
...
image::aws-fsx-guest-7.png[client aws fsx 7]
...
image::aws-fsx-guest-8.png[client aws fsx 8]

image::aws-fsx-guest-9.png[client aws fsx 9]

image::aws-fsx-guest-10.png[client aws fsx 10]
...
image::aws-fsx-guest-11.png[client aws fsx 11]
...
image::aws-fsx-guest-20.png[client aws fsx 20]

. Une fois exécutée, exécutez la commande df pour valider le montage.


image::aws-fsx-guest-21.png[client aws fsx 21]
...
image::aws-fsx-guest-22.png[client aws fsx 22]
...
image::aws-fsx-guest-23.png[client aws fsx 23]

. Choisissez un nouveau partage et suivez l'assistant Créer un dossier partagé.


image::aws-fsx-guest-24.png[client aws fsx 24]

image::aws-fsx-guest-25.png[client aws fsx 25]
...
image::aws-fsx-guest-26.png[client aws fsx 26]
...
image::aws-fsx-guest-30.png[client aws fsx 30]
...
image::aws-fsx-guest-31.png[client aws fsx 31]
...
image::aws-fsx-guest-32.png[client aws fsx 32]
...
image::aws-cvo-guest-1.png[invité aws cvo 1]
...
image::aws-cvo-guest-2.png[invité aws cvo 2]
...
image::aws-cvo-guest-3.png[invité aws cvo 3]
...
image::aws-cvo-guest-9.png[invité aws cvo 9]

. Sur la page chiffrement des données, choisissez le chiffrement géré par AWS.


image::aws-cvo-guest-10.png[invité aws cvo 10]
...
image::aws-cvo-guest-11.png[invité aws cvo 11]
...
image::aws-cvo-guest-12.png[invité aws cvo 12]
...
image::aws-cvo-guest-20.png[invité aws cvo 20]
...
image::aws-cvo-guest-21.png[invité aws cvo 21]
...
image::aws-cvo-guest-22.png[invité aws cvo 22]
...
image::aws-cvo-guest-23.png[invité aws cvo 23]

image::aws-cvo-guest-24.png[invité aws cvo 24]
...
image::aws-cvo-guest-30.png[invité aws cvo 30]

image::aws-cvo-guest-31.png[invité aws cvo 31]
...
image::aws-cvo-guest-32.png[invité aws cvo 32]
...
image::aws-cvo-guest-33.png[invité aws cvo 33]
...
image::aws-cvo-guest-34.png[invité aws cvo 34]
...
image::aws-cvo-guest-40.png[invité aws cvo 40]

image::aws-cvo-guest-41.png[invité aws cvo 41]
