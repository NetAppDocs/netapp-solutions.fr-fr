...
Pour plus d'informations sur les solutions NetApp avec VMware, suivez link:../vmware/index.html["ce lien"^].
...
[%collapsible%open]
====
Pour accéder à Google Cloud NetApp volumes pour AWS, vous devez acquérir les compétences et les informations suivantes :
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/concept-modes.html["Inscrivez-vous à Cloud Central"^] si ce n'est pas déjà fait.
