...
Pour en savoir plus sur VMware Cloud Foundation, rendez-vous sur le https://["Documentation VMware Cloud Foundation"^].
...
Pour plus d'informations sur VMware vSphere, veuillez suivre https://["ce lien"^].

Pour plus d'informations sur les solutions NetApp avec VMware, suivez https://["ce lien"^].
...
Pour plus d'informations sur VMware NSX, consultez https://["ce lien"^].
...
Pour plus d'informations sur NetApp ONTAP, suivez https://["ce lien"^].
...
Pour plus d'informations sur les outils NetApp ONTAP pour VMware, suivez https://["ce lien"^].
...
Pour plus d'informations sur NetApp SnapCenter, suivez https://["ce lien"^].
...
Pour plus d'informations sur Veeam Backup & Replication, consultez https://["ce lien"^].
...
Pour plus d'informations sur AIM, suivez la https://["ce lien"^].
...
Pour plus d'informations sur VMware Cloud sur AWS, suivez https://["ce lien"^].
...
Pour plus d'informations sur Amazon FSX pour NetApp ONTAP, suivez https://["ce lien"].
...
Pour plus d'informations sur les meilleures pratiques avec MS SQL et NetApp ONTAP, vous pouvez suivre https://["ce lien"^].

=====
.Oracle
[%collapsible]
=====
Dans le cadre de cette validation, nous utilisons ORACLE pour démontrer la reprise sur incident. Pour plus d'informations sur les meilleures pratiques avec ORACLE et NetApp ONTAP, vous pouvez suivre https://["ce lien"^].

=====
.Veeam
[%collapsible]
=====
Dans le cadre de cette validation, nous utilisons Veeam pour démontrer la reprise sur incident. Pour plus d'informations sur les meilleures pratiques avec Veeam et NetApp ONTAP, vous trouverez ci-dessous https://["ce lien"^].
...
* https://["Inscrivez-vous à Cloud Central"^] si ce n'est pas déjà fait.
* https://["Connectez-vous à Cloud Manager"^].
* https://["Configurez des espaces de travail et des utilisateurs"^].
* https://["Créer un connecteur"^].
...
Pour obtenir la liste plus complète des ports requis pour le logiciel Veeam Backup & Replication, suivez ces instructions https://["ce lien"^].

Pour obtenir une liste plus complète des ports requis pour SnapCenter, suivez la https://["ce lien"^].
...
NOTE: Des coûts de transfert de données sont associés à l'utilisation d'une passerelle de transit. Pour plus de détails sur les coûts spécifiques à une région, voir https://["ce lien"^].
...
[%collapsible]
=====
Pour déployer AWS FSX pour NetApp ONTAP à l'aide de Cloud Manager, suivez les instructions indiquées à l'adresse https://["ce lien"^].
...
[%collapsible]
=====
Vous pouvez installer le serveur Veeam Backup & Replication sur un serveur Windows dans VMware Cloud sur AWS ou sur une instance EC2. Pour obtenir des conseils détaillés sur la mise en œuvre, reportez-vous au https://["Documentation technique du centre d'aide Veeam"^].
