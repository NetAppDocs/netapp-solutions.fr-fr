...
. Sur la page *destination*, sélectionnez la destination en tant que cluster/hôtes SDDC GCVE et le pool de ressources, le dossier VM et le datastore GCNV appropriés pour les répliques VM. Cliquez sur *Suivant* pour continuer.
+
