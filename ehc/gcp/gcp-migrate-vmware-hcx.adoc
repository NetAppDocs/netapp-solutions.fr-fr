...
* L'utilisation d'un Software-Defined Data Center (SDDC) Google Cloud VMware Engine ou la création d'un cloud privé à l'aide de ce protocole https://docs.netapp.com/us-en/netapp-solutions/ehc/gcp/gcp-setup.html["Lien NetApp"^] ou ceci https://cloud.google.com/vmware-engine/docs/create-private-cloud["Lien Google"^].
