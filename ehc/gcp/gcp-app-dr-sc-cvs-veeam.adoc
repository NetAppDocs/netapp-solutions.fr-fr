...
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=8b7e4a9b-7de1-4d48-a8e2-b01200f00692["Tâche de réplication Veeam de SQL VM"]

====
.Le basculement de la machine virtuelle Microsoft SQL Server
[%collapsible]
====
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=9762dc99-081b-41a2-ac68-b01200f00ac0["Basculement de SQL VM"]
