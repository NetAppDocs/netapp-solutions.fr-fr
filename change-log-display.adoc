...
| 2025-06-30 | Base de données | Nouvelle boîte à outils d'automatisation : « Cycle de vie automatisé du clonage Oracle VLDB avec sauvegarde d'image sur serveur » 


| 2025-06-09 | Base de données | Nouveau TR-5007 : « Optimiser la sauvegarde et la récupération Oracle VLDB grâce à la fusion incrémentielle sur serveur sur les volumes NetApp de Google Cloud » 


| 2025-05-12 | Base de données | Ajoutez une vidéo de démonstration pour le clonage de base de données Oracle hors veille DataGuard sur GCNV avec ASM 


| 2025-05-08 | Virtualisation | Publier la version GA de la boîte à outils de quart 


| 2025-05-07 | Base de données | Nouveau kit d'outils d'automatisation des bases de données : « Automated Oracle Clone Lifecycle on GCNV with ASM » 


| 2025-04-23 | Base de données | Nouveau TR-5006 : « High Throughput Oracle VLDB Implementation on GCNV with Data Guard » 


| 2025-03-28 | Base de données | Kit d'outils d'automatisation des mises à jour : « SnapCenter Oracle Clone Lifecycle Automation » pour la prise en charge d'ANF 


| 2025-03-19 | Base de données | Nouveau kit d'outils d'automatisation : cycle de vie automatisé des clones Oracle sur ANF avec ASM 
...
| 03/01/2022 | Conteneurs | Ajout de nouvelles sections à NVA-1160 : installation de Trident Protect via OperatorHub et Ansible 
...
| 10/04/2021 | Conteneurs | Ajout d'une nouvelle vidéo de démonstration : migration des workloads à l'aide de Trident Protect vers NVA-1160 
...
| 08/05/2021 | Conteneurs | Ajout d'une nouvelle intégration technologique à NVA-1160 - NetApp Trident Protect sur Red Hat OpenShift 
