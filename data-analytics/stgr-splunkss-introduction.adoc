...
image:stgr-splunkss-image1.png["Erreur : image graphique manquante"]
...
Pour plus d'informations sur la façon dont StorageGRID vous aide à résoudre vos problèmes les plus complexes en matière de gestion des données non structurées, consultez le https://["Page d'accueil de NetApp StorageGRID"^].
...
link:stgr-splunkss-benefits-of-this-solution.html["Ensuite, les avantages de cette solution."]
