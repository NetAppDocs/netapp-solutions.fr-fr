...
. Pour déployer Astra Control Center sur un playbooks Ansible, un ordinateur Ubuntu/RHEL doit être installé sur Ansible. Suivre la procédure décrite link:../automation/automation_ubuntu_debian_setup.html["ici"] Pour Ubuntu et link:../automation/automation_rhel_centos_setup.html["ici"] Pour RHEL.
