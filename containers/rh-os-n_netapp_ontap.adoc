...
Amazon FSX pour NetApp ONTAP fournit un stockage partagé entièrement géré dans le cloud AWS avec les fonctionnalités courantes d'accès aux données et de gestion d'ONTAP. Pour plus d'informations sur Amazon FSX pour NetApp ONTAP, cliquez sur https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/what-is-fsx-ontap.html["ici"].
