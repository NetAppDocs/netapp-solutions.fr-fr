...
Pour plus d'informations sur OSP, consultez le https://["Site Web de Red Hat OpenStack Platform"^].
...
Pour configurer des groupes d'affinités, voir https://["Comment configurer l'affinité et la anti-affinité pour les instances OpenStack ?"^].
