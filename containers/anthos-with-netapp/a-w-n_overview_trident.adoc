...
La documentation de la dernière version d'Astra Trident est disponible https://["ici"]. Une matrice de prise en charge pour quelle version de Trident a été testée avec laquelle une distribution Kubernetes est disponible https://["ici"].
...
Pour plus d'informations sur l'installation d'Astra Trident, reportez-vous à la section https://["ici"].
