...
image:a-w-n_Anthos-1.14-vsphere7_validation.png["Erreur : image graphique manquante"]
...
https://["Documentation vSphere 6.7 : utilisation des règles d'affinité DRS"^].https://["Documentation vSphere 7.0 : utilisation des règles d'affinité DRS"^].
