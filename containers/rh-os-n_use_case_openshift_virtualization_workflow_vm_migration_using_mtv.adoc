...
**Trident backend pour iSCSI** exemple de fichier yaml pour créer la configuration Trident backend pour le stockage ONTAP san avec protocole iSCSI
...
spec:
  ...
  credentials:
    name: backend-tbc-ontap-san-secret
----
**Classe de stockage Trident pour iSCSI** exemple de fichier yaml pour créer une configuration de classe de stockage Trident pour le stockage ONTAP san avec protocole iSCSI
...
----
**Installation du back-end FC et de la classe de stockage** exemple de fichier yaml pour créer la configuration du back-end Trident pour le stockage san ONTAP avec protocole FC
...
spec:
  ...
  credentials:
    name: tbc-fc-secret
----
Exemple de fichier yaml pour créer une configuration de classe de stockage Trident pour le stockage san ONTAP avec protocole FC **classe de stockage Trident pour FC**
