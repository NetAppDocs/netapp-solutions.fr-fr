...
Pour obtenir des informations sur les exigences matérielles et logicielles pour Anthos, consultez le https://cloud.google.com/anthos/gke/docs/bare-metal/concepts/hw-sw-storage["Documentation Anthos sur les métaux nus"^] page.
