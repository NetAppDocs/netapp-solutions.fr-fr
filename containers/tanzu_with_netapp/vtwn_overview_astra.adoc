...
. Pour déployer Astra Control Center, vous devez disposer d'un ordinateur Ubuntu/RHEL avec Ansible. Suivre les procédures https://["ici"] Pour Ubuntu et RHEL.
...
NOTE: En cas de problème avec l'installation ou la configuration de NetApp Astra Control Center, la base de connaissances des problèmes connus est disponible https://["ici"^].



link:vtwn_astra_register.html["Ensuite : enregistrez vos clusters Kubernetes Tanzu."]
