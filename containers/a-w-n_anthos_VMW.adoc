...
image::a-w-n_anthos_controlplanev2_vm_architecture.png[architecture des machines virtuelles anthos controlplanev2]
...
image::a-w-n_anthos-128-vsphere8_validation.png[a p n validation anthos 128 vsphere8]
