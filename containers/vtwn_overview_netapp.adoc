...
summary: NetApp dispose de plusieurs plateformes de stockage compatibles avec Trident et Trident Protect pour provisionner, protéger et gérer les données des applications conteneurisées et contribuer ainsi à définir et à optimiser le débit DevOps. 
---
...
[role="lead"]
NetApp dispose de plusieurs plateformes de stockage compatibles avec Trident et Trident Protect pour provisionner, protéger et gérer les données des applications conteneurisées et contribuer ainsi à définir et à optimiser le débit DevOps.
