...
Pour plus d'informations sur RHV, reportez-vous au https://["Site Web Red Hat Virtualization"^].
...
Pour configurer des groupes d'affinités, reportez-vous à la section https://["Red Hat 6.11. Documentation des groupes d'affinités"^].
