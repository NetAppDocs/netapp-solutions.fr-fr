...
+
image:redhat_openshift_image15.jpeg["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:redhat_openshift_image19.jpeg["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:redhat_openshift_image22.jpeg["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]

. Autoriser le compte de service Jenkins à accéder aux utilisateurs OpenShift.
+
image:redhat_openshift_image23.jpeg["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:redhat_openshift_image25.jpeg["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
