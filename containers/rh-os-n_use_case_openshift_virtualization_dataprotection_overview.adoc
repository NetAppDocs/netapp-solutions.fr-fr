...
[role="lead"]
Ce document de référence fournit des informations détaillées sur la création de sauvegardes de machines virtuelles à l'aide de l'API OpenShift pour la protection des données (OADP) avec Velero et leur transfert vers ONTAP S3. Les sauvegardes des demandes de PVCS des machines virtuelles sont créées à l'aide des snapshots CSI Astra Trident.
...
**Les versions de composants suivantes sont celles des exemples de cette section**
