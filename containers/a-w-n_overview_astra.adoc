...
Pour l'installation et la configuration de Trident afin de prendre en charge Astra Control Center, voir link:rh-os-n_overview_trident.html["de ce document"^].
