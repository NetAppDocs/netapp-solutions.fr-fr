...
. Visitez Red Hat OpenShift https://["site web"^] Et connectez-vous à l'aide de votre login SSO.
...
. Suivez le https://["instructions d'installation"] Fourni par Red Hat pour un déploiement dans l'environnement de votre choix.
