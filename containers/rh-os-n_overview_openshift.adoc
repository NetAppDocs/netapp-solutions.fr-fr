...
+
image:redhat_openshift_image8.jpeg["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
...
+
image:redhat_openshift_image9.jpeg["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
