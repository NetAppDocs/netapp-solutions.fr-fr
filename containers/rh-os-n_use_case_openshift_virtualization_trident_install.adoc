...
====
'''
Encadré : lien latéral : conteneurs/rh-os-n_use_case_openshift_virtualization_trident_install.html mots-clés : OpenShift, OCP, Trident, Trident Protect, NetApp ONTAP, Red Hat OpenShift, virtualisation OpenShift, Résumé de la virtualisation Red Hat OpenShift avec NetApp ONTAP ---
