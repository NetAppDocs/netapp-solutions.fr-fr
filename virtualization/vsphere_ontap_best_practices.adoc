...
| Prise en charge des chemins d'accès | Non | ESXi 7.0U3f et versions ultérieures prennent en charge l'agrégation de sessions avec ONTAP 9.12.1RC1 et versions ultérieures 
|===
