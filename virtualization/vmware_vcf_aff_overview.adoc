...
* Déploiement de domaines de charge de travail virtuels virtuels (VCF VI) à l'aide de ONTAP en tant que stockage principal (NFS, vVol).
...
* *Configurer et utiliser un datastore NFS comme stockage principal pendant le déploiement de VI Workload Domain.* cliquez sur link:https://review.docs.netapp.com/us-en/netapp-solutions_vcf_asa_aff/virtualization/vsphere_ontap_auto_block_fc.html["*ICI*"] pour les étapes de déploiement. Cliquez sur link:https://review.docs.netapp.com/us-en/netapp-solutions_vcf_asa_aff/virtualization/vsphere_ontap_auto_block_fc.html["*ICI*"]
* *Configurer et utiliser un datastore vVol comme stockage principal pendant le déploiement de VI Workload Domain.* cliquez sur le lien :
* *Installez et démontrez l'utilisation des outils ONTAP pour configurer et monter des datastores NFS en tant que stockage supplémentaire dans des domaines de charge de travail VI.* cliquez sur link:link:https://review.docs.netapp.com/us-en/netapp-solutions_vcf_asa_aff/virtualization/vsphere_ontap_auto_block_fc.html["*ICI*"]
