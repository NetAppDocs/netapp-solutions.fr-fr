...
Pour plus d'informations, voir link:https://docs.netapp.com/us-en/netapp-solutions/vm-migrate/migrate-overview.html["Migration des machines virtuelles entre différents environnements de virtualisation (Shift Toolkit)"].
