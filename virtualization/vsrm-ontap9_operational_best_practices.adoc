...
....
La taille automatique du volume doit être définie sur `grow` Pour les volumes contenant les datastores SAN et `grow_shrink` Pour les datastores NFS. Reportez-vous à la https://["Centre de documentation ONTAP 9"^] pour la syntaxe spécifique.
