...
** Lien :../ehc/gcp-migrate-vmware-hcx.html [migrer des workloads vers le datastore Google Cloud NetApp volumes sur Google Cloud VMware Engine avec VMware HCX - Guide de démarrage rapide]
