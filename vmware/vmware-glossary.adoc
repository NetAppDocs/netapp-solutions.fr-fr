...
* link:https://docs.netapp/com/us-en/vontap-apps-dbs/vmware/vmware-vsphere-overview.html["NetApp ONTAP prend en charge tous les protocoles de stockage"]
...
* link:https://docs.netapp.com/us-en/ntap-apps-dbs/vmware/vmware-srm-overview.html["VMware site Recovery Manager et NetApp ONTAP 9"]
