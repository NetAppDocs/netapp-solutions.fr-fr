...
Pour migrer des machines virtuelles d'autres datastores vers un datastore vVol, plusieurs options sont disponibles en fonction du scénario. Elle peut varier d'une simple opération Storage vMotion à une migration à l'aide de HCX. Voir link:https://docs.netapp.com/us-en/netapp-solutions/vmware/migrate-vms-to-ontap-datastore.html["Migrer des machines virtuelles vers un datastore ONTAP"] pour plus de détails.



== Migration des VM entre les datastores vVol

Pour la migration en bloc de machines virtuelles entre les datastores vVol, vérifiez link:https://docs.netapp.com/us-en/netapp-solutions/vmware/migrate-vms-to-ontap-datastore.html["Migrer des machines virtuelles vers un datastore ONTAP"].
